                                ...
                                <form action="profile.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="text" class="mb-4 form-control" name="nickname" maxlength="50"
                                            value="<?php echo htmlspecialchars($view_user['nickname']);?>" placeholder="ニックネーム" required>

                                        <label class="mb-1">ユーザー名</label>
                                        <input type="text" class="mb-4 form-control" name="name" maxlength="50"
                                            value="<?php echo htmlspecialchars($view_user['name']);?>" placeholder="ユーザー名" required>

                                        <label class="mb-1">メールアドレス</label>
                                        <input type="email" class="mb-4 form-control" name="email" maxlength="254"
                                            value="<?php echo htmlspecialchars($view_user['email']);?>" placeholder="メールアドレス" required>
